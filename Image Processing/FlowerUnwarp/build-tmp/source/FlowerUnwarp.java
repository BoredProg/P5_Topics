...
public class FlowerUnwarp extends PApplet {
...
public void setup() {
  ...
  maxRadiusPercent = 0.98f;
  minRadiusPercent = 0.05f;
  verticalPow = 1.50f;
  aspectRatio = 4.5f;
  bUseCubicInterpolation = false;
  
  controlP5 = new ControlP5(this);
  controlP5.addSlider("maxRadiusPercent", 0.0f, 1.0f, 0.80f,  900, 10,300,15);
  controlP5.addSlider("minRadiusPercent", 0.0f, 0.5f, 0.05f,  900, 30,300,15);
  controlP5.addSlider("verticalPow",      1.0f, 2.0f, 1.50f,  900, 50,300,15);
  controlP5.addSlider("aspectRatio",      2.0f, 7.0f, 6.00f,  900, 70,300,15);
...
public void loadFlower() {
  ...
  if (inputFileName.endsWith("jpg") || inputFileName.endsWith("JPG")) {
    ...
    max_radius  = inputImageH/2.0f * maxRadiusPercent;
    min_radius  = inputImageH/2.0f * minRadiusPercent;
    imgCx = inputImageW/2;
    imgCy = inputImageH/2;
...
//=============================================
public void computeInversePolarTransform() {
...
//=============================================
public void unwarpNearestNeighbor() {
...
public void unwarpBicubic() {
  ...
  int patchRow;
  int inputPixels[] = inputImage.pixels;
...
//=============================================
public float bicubicInterpolate (int[][] p, float x,float y, float x2,float y2, float x3,float y3) {
...
public String[] listFileNames(String dir) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "FlowerUnwarp" };
    if (passedArgs != null) {
