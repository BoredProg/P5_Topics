...
float separation = 0.5; float alignment = 0.02; float cohesion = 0.5;
...
void NeighbourhoodSlider(float value) {    
  neighbourhood = value;
}
...
void CohesionSlider(float value) {
  cohesion = value;
}
 
void AlignmentSlider(float value) {
  alignment = value;
}
 
void SeparationSlider(float value) {
  separation = value;
}
