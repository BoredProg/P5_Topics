...
public class P5_211_RibbonsBest_Smoking extends PApplet {
...
public void restart() {
  ...
  ribbonManager.setGravity(-0.09f);                   // default = .03
...
public void draw() {
  ...
  _angle = PApplet.parseInt(random(360));
  _noiseoff += 0.05f;
  _b = (noise(_noiseoff) * 8) +1;
  _a = _b;
  
  translate(_centx, _centy);
  ribbonManager.update(newx* 0.1f, newy*0.1f);
}
...
class RibbonManager {
  ...
  public void addRibbon() {
    ...
    for (int i = 0; i < _numRibbons; i++) {
      int ribbonColour = color(random(255), ((40/_numRibbons) * i) ) ;
...
class RibbonParticle {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "P5_211_RibbonsBest_Smoking" };
    if (passedArgs != null) {
