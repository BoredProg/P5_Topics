...
public class Texture2DAnimation extends PApplet {
...
float W = 1.0f/DIM; // calculate the normalized width of one cell in the spritesheet grid
float H = 1.0f/DIM; // calculate the normalized height of one cell in the spritesheet grid
...
public void draw() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Texture2DAnimation" };
    if (passedArgs != null) {
