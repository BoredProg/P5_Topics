...
public class RoseKinda extends PApplet {
...
{     
  ...
  for (int j=0;j<n/2;j++) {
    ...
    for (int i=0;i<=n;i++) {
      ...
      int lookx = abs(PApplet.parseInt(x1*n));
      int looky = abs(PApplet.parseInt(y1*n));
      ...
      lookx = abs(PApplet.parseInt(x1*n));
      looky = abs(PApplet.parseInt(y1*n));
      r = z[lookx][looky];      
      x2 = r * x1;
      y2 = r * y1;
      z2 = r * z1;
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "RoseKinda" };
    if (passedArgs != null) {
