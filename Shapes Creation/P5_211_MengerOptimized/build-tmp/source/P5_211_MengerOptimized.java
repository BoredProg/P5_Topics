...
public class P5_211_MengerOptimized extends PApplet {
...
public void setup(){
  ...
  cam.setRotations( -1.3968815f, 0.71367186f, -0.12572986f);
...
public final void mengerSpongeProc(){
  FACES_RENDERED = 0;
...
// Menger Sponge
public final void menger(float x, float y, float z, float s, int F){
...
public final void box(float x, float y, float z, float s, int F){
...
public final void quad(final PVector a, final PVector b, final PVector c, final PVector d){
  vertex(a.x, a.y, a.z);
  vertex(b.x, b.y, b.z);
  vertex(c.x, c.y, c.z);
  vertex(d.x, d.y, d.z);
...
public void keyReleased(){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "P5_211_MengerOptimized" };
    if (passedArgs != null) {
