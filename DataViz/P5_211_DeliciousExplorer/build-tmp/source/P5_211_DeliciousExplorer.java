...
public class P5_211_DeliciousExplorer extends PApplet {
...
class Circle {
  ...
  public void draw(){
    ...
    for(int i= 0; i<relations.length; i++){
      ...
      translate(max(0,400 *1.5f - frameCount*4), (fontSize / 2));      
      textFont(font);
      textSize(fontSize);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "P5_211_DeliciousExplorer" };
    if (passedArgs != null) {
