...
//    tex6 = TextureIO.newTexture(new File(dataPath(skyboxName + "_top" + fExt)), true);
    ...
    tex1 = TextureIO.newTexture(new File(dataPath(skyboxName + "_negative_z" + fExt)), true);
    tex2 = TextureIO.newTexture(new File(dataPath(skyboxName + "_positive_z" + fExt)), true);
    tex3 = TextureIO.newTexture(new File(dataPath(skyboxName + "_negative_x" + fExt)), true);
    tex4 = TextureIO.newTexture(new File(dataPath(skyboxName + "_positive_x" + fExt)), true);
    tex5 = TextureIO.newTexture(new File(dataPath(skyboxName + "_negative_y" + fExt)), true);
    tex6 = TextureIO.newTexture(new File(dataPath(skyboxName + "_positive_y" + fExt)), true);
